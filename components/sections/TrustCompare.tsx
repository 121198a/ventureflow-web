...
export function TrustCompare() {
  return (
    <section className="bg-slate-50/70 border-y border-slate-200/80 px-5 py-20 sm:py-28">
      <Reveal className="mx-auto max-w-[900px] text-center">
        ...
        <h2 className="mx-auto mt-5 max-w-2xl text-3xl font-extrabold leading-tight text-slate-900 sm:text-4xl lg:text-5xl tracking-tight">
          <span className="text-blue-600"><CountUp value={61} suffix="%" /></span> of investors under 35 source investment ideas from social feeds.
        </h2>
        ...
        <p className="mx-auto mt-4 max-w-xl text-base sm:text-lg font-medium text-slate-600 leading-relaxed">
      ...
      <div className="relative mx-auto mt-16 grid grid-cols-1 max-w-[1100px] items-stretch gap-8 md:grid-cols-2">
        ...
        <Reveal direction="left" className="w-full min-w-0 flex flex-col rounded-2xl border border-slate-200 bg-white/70 p-6 sm:p-8 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            <p className="text-sm font-bold uppercase tracking-wider text-slate-500">
              Unverified Social Discourse
            </p>
            <span className="rounded-full bg-slate-100 px-2.5 py-0.5 text-micro font-semibold text-slate-600">
              Zero Accountability
            </span>
          </div>
          ...
          <div className="flex-1 rounded-xl border border-slate-200/90 bg-white p-4 sm:p-5 shadow-xs">
            ...
            <div className="mt-4 flex items-center gap-2.5 border-t border-slate-100 pt-3.5">
              <span className="grid h-7 w-7 place-items-center rounded-full bg-slate-100 text-micro font-bold text-slate-600">
                DR
              </span>
              <p className="text-xs">
          ...
          <div className="mt-4 rounded-xl border border-dashed border-rose-200 bg-rose-50/50 p-4 text-center">
            <p className="text-xs font-bold text-rose-700 tracking-wide">No Verification Mechanism</p>
            <p className="mt-0.5 text-xs text-slate-600">No locked target, no fixed timeframe, no recorded outcome history.</p>
          </div>
        </Reveal>

        {/* With Track Record (Right Side - UnBound X) */}
        <Reveal direction="right" className="gb-interactive-card relative w-full min-w-0 flex flex-col rounded-2xl border-2 border-blue-600 bg-white p-6 sm:p-8 shadow-xl shadow-blue-600/5">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="rounded-full bg-blue-50 px-2.5 py-0.5 text-micro font-bold text-blue-700">
              Immutable
            </span>
          </div>
          ...
          <div className="flex-1 rounded-xl border border-slate-200/90 bg-slate-50/50 p-4 sm:p-5 shadow-xs">
            ...
            <div className="mt-3.5 flex flex-wrap items-center justify-between gap-2 text-xs">
              ...
              <span className="flex flex-wrap items-center gap-1.5">
                <span className="flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-0.5 font-bold text-emerald-700 border border-emerald-100 text-micro">
          ...
          <div className="mt-4 flex items-center justify-between rounded-xl border border-slate-200 bg-white p-4 shadow-xs">
            ...
            <div className="shrink-0 text-right pl-3">
              <p className="text-xl font-black text-slate-900 leading-none">58.5%</p>
