/** Google/Apple OAuth row — only appears on the Investor Login (fully
    rendered in the reference) and Investor Signup. Clearly marked as
    unconfigured / coming soon rather than shipping dead interactive elements. */
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
      <button
        ...
        className="flex items-center justify-center gap-2 rounded-md border border-hairline bg-background py-3 text-[0.85rem] text-ink/50 cursor-not-allowed opacity-60"
        style={{ fontWeight: 600 }}
      >
        <svg viewBox="0 0 48 48" className="size-4 opacity-70" aria-hidden>
          <path
            fill="#FFC107"
      ...
      <button
        type="button"
        disabled
        title="Apple sign-in is not configured in this environment"
        className="flex items-center justify-center gap-2 rounded-md border border-hairline bg-background py-3 text-[0.85rem] text-ink/50 cursor-not-allowed opacity-60"
        style={{ fontWeight: 600 }}
      >
        <svg viewBox="0 0 24 24" className="size-4 opacity-70" fill="currentColor" aria-hidden>
