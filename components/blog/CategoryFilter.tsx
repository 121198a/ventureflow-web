        ...
        {categories.map((cat) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative shrink-0 rounded-full px-4 py-2 text-xs sm:text-sm font-semibold transition-colors cursor-pointer",
                isActive ? "text-white" : "text-slate-600 hover:text-slate-900 bg-slate-100"
              )}
            >
              {isActive && (
                <motion.span
