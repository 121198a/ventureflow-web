  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        elevated: "0 10px 30px rgba(15, 23, 42, 0.07), 0 2px 8px rgba(15, 23, 42, 0.04)",
        modal: "0 20px 50px rgba(15, 23, 42, 0.12), 0 4px 12px rgba(15, 23, 42, 0.06)",
        glow: "0 0 24px rgba(30, 64, 175, 0.12)",
