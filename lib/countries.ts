...
/**
 * Comprehensive international country calling codes list.
 * Includes all standard international prefixes, ISO codes, and flag emojis.
 */
export const ALL_COUNTRIES: Country[] = [
  // Primary / High-traffic countries
  ...
  // Alphabetical international list
